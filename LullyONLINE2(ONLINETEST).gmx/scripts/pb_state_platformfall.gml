...
if((place_meeting_rounded(x,y+1,PAR_Wall) || position_meeting_rounded(x,y,obj_ramp)) && y_speed == 0)
{
    if(x_speed==0)
        state_switch("Stand");
    else
...
if(!place_meeting_rounded(x,y,PAR_Platform))
{
    state_switch("Air")
}
