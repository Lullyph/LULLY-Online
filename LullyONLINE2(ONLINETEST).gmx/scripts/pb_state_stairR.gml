///pb_state_stairR()
//The Stair Right State for Platform Girl
if(state_new)
{
    x_speed=0;
    y_speed=0;
...
//Stair ASCEND
if(self.up_held && self.right_held)
    {
        image_speed = 0.25;
        image_xscale=1;
        x_speed=0;
...
if(self.up_held && self.right_held){
if((position_meeting_rounded(x,y+4,PAR_Platform) && !place_meeting_rounded(x,y,obj_stairR)))
    {
        state_switch("Stand");
    }
}
